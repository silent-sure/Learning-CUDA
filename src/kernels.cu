 ...
 * This function expects a flattened row-major matrix stored in a* std::vector.
 * If the matrix is not square, the trace will sum up* elements along the main
 * diagonal up to the smaller of rows or cols.
 *
